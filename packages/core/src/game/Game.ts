...
export default class Game {
  ...
  clear(): Game {
    const newFirst = this.first.type === this.player1.type ? this.player2 : this.player1;
    return new Game(this.player1, this.player2, Board.empty(), newFirst, newFirst);
  }
  ...
  private switchPlayer(): Game {
    ...
    return new Game(this.player1, this.player2, this.board, this.first, newCurrent, this.ties, this.result);
  }
}
